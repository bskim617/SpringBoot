...
public class MainController {
	...
	public String query5() {
		List<User1VO> users = repo.findUser1VOByUidOrName("a101", "홍길동");
	...
	public String query7() {
		List<User1VO> users = repo.findUser1VOByAgeGreaterThanEqual(40);
	...
	public String query8() {
		List<User1VO> users = repo.findUser1VOByAgeLessThan(40);
	...
	public String query9() {
		List<User1VO> users = repo.findUser1VOByAgeLessThanEqual(39);
	...
	public String query11() {
		List<User1VO> users = repo.findUser1VOByNameContains("유");
	...
	public String query17() {
		List<User1VO> users = repo.findUser1VOByAgeGreaterThanOrderByAgeDesc(40);
